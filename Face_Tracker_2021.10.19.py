...
2021.10.19 updates
-----------------
I've been busy with a vacation and dormitory for a while. Today
I setup my system to my dorm room and ready to start work again.

Trying to take screenshots from captured faces
...
while True:
	...
	for (objectID, centroid,) in objects.items():
		...
		if objectID+1 > total_face:
			...
			# TEST AREA FOR CAPTURING FACE SCREENSHOSTS
			#frame1 = vs.()
			#cv2.imwrite("captured_face", frame1)
